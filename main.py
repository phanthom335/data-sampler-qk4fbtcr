        """
        Data Sampler Qk4fbtcr
        =====================
        Schema-aware processor designed to deduplicate raw data into clean outputs.
...
from pathlib import Path
        ...
        APP_NAME    = "Data Sampler Qk4fbtcr"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Schema-aware processor designed to deduplicate raw data into clean outputs.")
